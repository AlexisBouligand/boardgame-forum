<?php
$PAGE_NAME = "Game Page";
$PAGE_HEAD = "<script src=\"/js/vote.js\" defer></script><link rel=\"stylesheet\" href=\"/css/game_page.css\" />";
  ...
  <article class="game">
    ...
    foreach ($search_res as $critic) {
        ...
        <aside class="player-critic">
            ...
            <div class="karma-box">
                <a class="like" name="like">
                    <span>&#x25b2;</span>
                </a>
                <span class="karma"><?php echo $critic->karma; ?></span>
                <a class="dislike" name="dislike">
                    <span>&#x25bc;</span>
                </a>
            </div >
